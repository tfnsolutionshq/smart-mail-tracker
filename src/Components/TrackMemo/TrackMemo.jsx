...
import { FiSearch, FiFileText, FiArrowRight, FiExternalLink, FiLoader } from 'react-icons/fi'
...
function TrackMemo() {
  ...
  const handleViewDetails = () => {
    setSelectedMemo(searchResult)
  }

  if (selectedMemo) {
    return <TrackMemoDetails onBack={() => setSelectedMemo(null)} memoData={selectedMemo} />
  }
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium ${
                  searchResult.priority === 'high' ? 'bg-orange-50 text-orange-700 border border-orange-100' :
