...
export default function RecordExternalSuccess() {
  ...
  console.log("over here: ", location.state);
      ...
      <div className="bg-white rounded-lg border border-green-200 p-8 mt-4">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mt-3">
            Memo Recorded Successfully!
          </h2>
          <p className="text-sm text-gray-600">
            The external memo has been recorded and assigned
          </p>
          ...
          <div className="bg-white border rounded-lg p-4 mt-6 w-full max-w-xl">
            ...
            {!qrCode && (
              <div className="mt-4 flex justify-center">
                <div className="w-24 h-24 rounded-lg border border-gray-300 bg-gray-50 flex items-center justify-center text-xs text-gray-400">
                  No QR
                </div>
              </div>
            )}
          ...
          <div className="flex items-center gap-3 mt-6">
            <button
              className="px-4 py-2 text-sm font-medium bg-white border border-gray-300 text-gray-700 rounded-lg"
              onClick={() => navigate("/record-external-memo")}
            >
              Record Another Memo
            </button>
            <button
              className="px-4 py-2 text-sm font-medium bg-gray-900 text-white rounded-lg"
              onClick={() => navigate("/record-memo")}
            >
              Back to Record Memo
            </button>
          </div>
