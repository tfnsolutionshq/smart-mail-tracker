        ...
        <Router>
          <Routes>
            <Route element={<PublicRouteGuard />}>
              ...
              <Route
                path="/memo-tracker"
                element={<UnauthenticatedTrackMemoPage />}
              />
              <Route
                path="/memo-tracker-details/:id"
                element={<UnauthenticatedTrackMemoDetailsPage />}
              />
            </Route>
            ...
            <Route element={<PrivateRouteGuard />}>
              ...
              <Route
                path="/record-external-memo"
                element={<RecordExternalMemoPage />}
              />
              <Route
                path="/record-external-attachments"
                element={<RecordExternalAttachmentsPage />}
              />
              <Route
                path="/record-external-assignment"
                element={<RecordExternalAssignmentPage />}
              />
              <Route
                path="/record-external-review"
                element={<RecordExternalReviewPage />}
              />
              <Route
                path="/record-external-success"
                element={<RecordExternalSuccessPage />}
              />
              <Route
                path="/view-external-memo"
                element={<ViewExternalMemoPage />}
              />
              <Route
                path="/record-memo-inbox"
                element={<RecordMemoInboxPage />}
              />
              <Route
                path="/record-memo-details/:id"
                element={<RecordMemoDetailsPage />}
              />
              ...
              <Route
                ...
                element={<WorkflowAdminDetailsPage />}
              />
              ...
              <Route
                path="/admin/mail-content/:id"
                element={<AdminMailContent />}
              />
              <Route path="/track-memo" element={<TrackMemoPage />} />
              <Route
                path="/track-memo-details/:id"
                element={<TrackMemoDetailsPage />}
              />
